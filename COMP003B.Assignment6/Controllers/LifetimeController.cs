...
namespace COMP003B.Assignment6.Controllers
{
    ...
    public class LifetimeController : Controller
    {
        ...
        private readonly MySingletonServices _singletonService1;
        private readonly MySingletonServices _singletonService2;

        // constructor
        public LifetimeController(MyTransientService transientService1, MyScopedService scopedService1, MySingletonServices singletonService1, MyTransientService transientService2, MyScopedService scopedService2, MySingletonServices singletonService2)
        {
